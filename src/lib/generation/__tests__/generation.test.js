...
exports.testGeneration = testGeneration;
...
function testGeneration() {
    ...
    for (const testCase of testCases) {
        const errors = [];
        try {
            const result = (0, index_1.generateAll)(testCase.input, testCase.locale, testCase.tone, testCase.length, testCase.hashtagCount);
            // Validate captions
            ...
            // Validate hashtags
            const totalHashtags = result.hashtags.brand.length +
